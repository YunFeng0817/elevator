...
HD_PWD='E:/vivado project/kb/kb.runs/design_1_dis_common_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_dis_common_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_dis_common_0_0.tcl
