...
CONFIG.FREQ_HZ {100000000} \
  ...
  set dnin [ create_bd_port -dir I dnin ]
  set dnout [ create_bd_port -dir O dnout ]
  set dpin [ create_bd_port -dir I dpin ]
  set dpout [ create_bd_port -dir O dpout ]
  set kb_clk [ create_bd_port -dir I -type clk kb_clk ]
  set_property -dict [ list \
CONFIG.FREQ_HZ {100000000} \
 ] $kb_clk
  set kb_data [ create_bd_port -dir I kb_data ]
  set numout [ create_bd_port -dir O -from 6 -to 0 numout ]
  ...
  connect_bd_net -net dnin_1 [get_bd_ports dnin] [get_bd_pins main_0/dnin]
  connect_bd_net -net dpin_1 [get_bd_ports dpin] [get_bd_pins main_0/dpin]
  connect_bd_net -net kb_0_PA [get_bd_pins kb_0/result] [get_bd_pins main_0/numin]
  ...
  connect_bd_net -net main_0_dnout [get_bd_ports dnout] [get_bd_pins main_0/dnout]
  connect_bd_net -net main_0_dpout [get_bd_ports dpout] [get_bd_pins main_0/dpout]
  connect_bd_net -net main_0_numout [get_bd_ports numout] [get_bd_pins main_0/numout]
  connect_bd_net -net one_HZ_time_0_clkout1M [get_bd_pins kb_0/s_clk] [get_bd_pins one_HZ_time_0/clkout1M]
